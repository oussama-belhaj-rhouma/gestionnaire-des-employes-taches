...
@Component({
  selector: 'app-tache-mod',
  templateUrl: './tache-mod.component.html',
  styleUrls: ['./tache-mod.component.css']
})
export class TacheModComponent {
  ...
  public searchTaches(key: string) {
    ...
    for (tache1 of this.taches) {
      if (
        tache1.name.toLowerCase().indexOf(key.toLowerCase()) !== -1 ||
